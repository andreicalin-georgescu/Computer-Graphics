...
void Laborator2::Init()
{
	...
	// Create a mesh box using custom data
	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, -1, 1), glm::vec3(0, 0.6f, 1)),
			VertexFormat(glm::vec3(-1, 0, 1), glm::vec3(0.2f, 1, 1)),
			VertexFormat(glm::vec3(0, 0, 1), glm::vec3(1, 1, 0)),
			VertexFormat(glm::vec3(-1, -1, 0), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(0, -1, 0), glm::vec3(0, 0.5f, 0.8f)),
			VertexFormat(glm::vec3(-1, 0, 0), glm::vec3(0, 1, 0)),
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.3f, 1, 0.2f)),
		};
...

	{
		vector<VertexFormat> vertices
		{
			...
			// TODO: Complete the information for the cube
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.6f, 1)),
			VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0.2f, 1, 1)),
			VertexFormat(glm::vec3(0.5f, 1.f, 0.5f), glm::vec3(1, 1, 0)),
		};
...

	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.6f, 0.2f, 1)),
			// TODO: Complete the information for the cube
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 1, 1)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.6f, 1)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.6f, 0.2f, 1)),
			VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(1, 1, 1)),
			VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0, 0.6f, 1)),
			VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(0.5f, 1.f, 0.5f), glm::vec3(0, 0.6f, 1)),
			VertexFormat(glm::vec3(0.5f, 1.f, 0.5f), glm::vec3(0, 0, 1)),
			VertexFormat(glm::vec3(0.5f, 1.f, 0.5f), glm::vec3(0.6f, 0.2f, 1))
		};
		...
		Mesh *tetraedru = CreateMesh("tetraedru2", vertices, indices);
	}

	{
		vector<VertexFormat> vertices
		{
			...
			VertexFormat(glm::vec3(0, 1, 0), glm::vec3(0, 0.2f, 0.3f)),
			VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0, 0.2f, 0.3f)),
			VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0, 0.2f, 0.3f))
		};
...
void Laborator2::Update(float deltaTimeSeconds)
{
	...
	RenderMesh(meshes["cube3"], shaders["VertexColor"], glm::vec3(0, 0, 0), glm::vec3(1.f));

	RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(0, 1, 0), glm::vec3(1.f));

	RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(1, 1, 1), glm::vec3(0.4f));

	RenderMesh(meshes["tetraedru2"], shaders["VertexColor"], glm::vec3(1, 2, 1), glm::vec3(0.4f));
